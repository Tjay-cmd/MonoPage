...
<body>
  <div class="error-container">
    ...
    // Use tutor-calendar-settings collection for tutors
    ...
    // Get lessons/bookings (handle gracefully if index doesn't exist)
    // Using same bookings collection but terminology is lessons for tutors
    let bookings: any[] = [];
    try {
...
<head>
  <meta charset="UTF-8">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Lesson Booking Calendar</title>
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    (function() {
      ...
      function updateModalContent() {
        ...
        const formHtml = '<form onsubmit="window.submitBooking(event)">' +
          ...
          '<input type="text" id="serviceType" placeholder="e.g., Math, English, Science"></div>' +
