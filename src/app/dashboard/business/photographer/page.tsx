...
export default function PhotographerDashboardPage() {
  ...
  // Bookings state (sessions for photographers)
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="ml-64 p-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-2">Calendar & Sessions</h1>
          <p className="text-lg text-gray-600">
            Configure your availability and manage photography session bookings
          </p>
        </div>
